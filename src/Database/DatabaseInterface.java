...
//=========================== CLASS VARIABLES ==================================
    public static final File userInfoFile = new File("Datastore" + File.separator + "UserInfo.txt");
    public static final File userLoginFile = new File("Datastore" + File.separator + "UserLogin.txt");
    public static final File userRatingFile = new File("Datastore" + File.separator + "UserRating.txt");
    public static final File userPlanToListen = new File("Datastore" + File.separator + "UserPlanToListen.txt");
    public static final File temporaryFile = new File("Datastore" + File.separator + "TemporaryFile.txt");
